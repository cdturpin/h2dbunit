DROP TABLE IF EXISTS ACS_POS_MONTHLY_CHAR;
DROP TABLE IF EXISTS ACS_POS_MONTHLY_STATS;
DROP TABLE IF EXISTS ACS_POS_TURNOVER;
DROP TABLE IF EXISTS BUSINESS_CALENDAR;

----------------------------------------------------------
----  DDL for Table ACS_POS_MONTHLY_CHAR
----------------------------------------------------------
CREATE TABLE ACS_POS_MONTHLY_CHAR 
   (	ENTITY_ID CHAR(8), 
	EFFECTIVE_DATE DATE, 
	POSITION_ID NUMBER, 
...
--  TABLESPACE TSDATA_EPAA ;
--------------------------------------------------------
--  DDL for Index PK40
--------------------------------------------------------

--  CREATE UNIQUE INDEX PK40 ON ACS_POS_MONTHLY_CHAR (ENTITY_ID, EFFECTIVE_DATE, LONG_SHORT_IND) 
--  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
--  STORAGE(INITIAL 1146880 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
--  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
--  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
--  TABLESPACE TSDATA_EPAA ;
----------------------------------------------------------
----  Constraints for Table ACS_POS_MONTHLY_CHAR
----------------------------------------------------------

--  ALTER TABLE ACS_POS_MONTHLY_CHAR ADD CONSTRAINT PK40 PRIMARY KEY (ENTITY_ID, EFFECTIVE_DATE, LONG_SHORT_IND)
--  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
--  STORAGE(INITIAL 1146880 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
--  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
--  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
--  TABLESPACE TSDATA_EPAA  ENABLE;
--  ALTER TABLE ACS_POS_MONTHLY_CHAR MODIFY (ENTITY_ID NOT NULL ENABLE);
--  ALTER TABLE ACS_POS_MONTHLY_CHAR MODIFY (EFFECTIVE_DATE NOT NULL ENABLE);
--  ALTER TABLE ACS_POS_MONTHLY_CHAR MODIFY (POSITION_ID NOT NULL ENABLE);
--  ALTER TABLE ACS_POS_MONTHLY_CHAR MODIFY (LAST_UPDATE_TS NOT NULL ENABLE);
--  ALTER TABLE ACS_POS_MONTHLY_CHAR MODIFY (LONG_SHORT_IND NOT NULL ENABLE);


  
--------------------------------------------------------
--  DDL for Table ACS_POS_MONTHLY_MPT_STATS
--------------------------------------------------------

  CREATE TABLE ACS_POS_MONTHLY_MPT_STATS 
   (	ENTITY_ID CHAR(8), 
	EFFECTIVE_DATE DATE, 
	STAT_TYPE VARCHAR2(20), 
	ENTITY_BMRK_RELATION_TYPE VARCHAR2(20), 
	BMRK_ENTITY_ID CHAR(8), 
	SRC_INTFC_INST NUMBER(*,0), 
...
--  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
--  TABLESPACE TSDATA_EPA ;
--------------------------------------------------------
--  DDL for Index PK_ACS_POS_MONTHLY_MPT_STATS
--------------------------------------------------------

--  CREATE UNIQUE INDEX PK_ACS_POS_MONTHLY_MPT_STATS ON ACS_POS_MONTHLY_MPT_STATS (ENTITY_ID, EFFECTIVE_DATE, STAT_TYPE, ENTITY_BMRK_RELATION_TYPE, BMRK_ENTITY_ID, SRC_INTFC_INST) 
--  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
--  STORAGE(INITIAL 1146880 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
--  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 MAXSIZE UNLIMITED
--  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
--  TABLESPACE TSINDX_EPA ;
--------------------------------------------------------
--  Constraints for Table ACS_POS_MONTHLY_MPT_STATS
--------------------------------------------------------

--  ALTER TABLE ACS_POS_MONTHLY_MPT_STATS ADD CONSTRAINT PK_ACS_POS_MONTHLY_MPT_STATS PRIMARY KEY (ENTITY_ID, EFFECTIVE_DATE, STAT_TYPE, ENTITY_BMRK_RELATION_TYPE, BMRK_ENTITY_ID, SRC_INTFC_INST)
--  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
--  STORAGE(INITIAL 1146880 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
--  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 MAXSIZE UNLIMITED
--  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
--  TABLESPACE TSINDX_EPA  ENABLE;
--  ALTER TABLE ACS_POS_MONTHLY_MPT_STATS MODIFY (LAST_UPDATE_TS NOT NULL ENABLE);
--  ALTER TABLE ACS_POS_MONTHLY_MPT_STATS MODIFY (SRC_INTFC_INST NOT NULL ENABLE);
--  ALTER TABLE ACS_POS_MONTHLY_MPT_STATS MODIFY (BMRK_ENTITY_ID NOT NULL ENABLE);
--  ALTER TABLE ACS_POS_MONTHLY_MPT_STATS MODIFY (ENTITY_BMRK_RELATION_TYPE NOT NULL ENABLE);
--  ALTER TABLE ACS_POS_MONTHLY_MPT_STATS MODIFY (STAT_TYPE NOT NULL ENABLE);
--  ALTER TABLE ACS_POS_MONTHLY_MPT_STATS MODIFY (EFFECTIVE_DATE NOT NULL ENABLE);
--  ALTER TABLE ACS_POS_MONTHLY_MPT_STATS MODIFY (ENTITY_ID NOT NULL ENABLE);

  
----------------------------------------------------------
----  DDL for Table ACS_POS_TURNOVER
----------------------------------------------------------

  CREATE TABLE ACS_POS_TURNOVER 
   (	ENTITY_ID CHAR(8), 
	EFFECTIVE_DATE DATE, 
	POSITION_ID NUMBER, 
	FREQUENCY CHAR(1), 
...
--  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
-- NOCOMPRESS LOGGING
--  STORAGE(INITIAL 4587520 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
--  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
--  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
--  TABLESPACE TSDATA_EPAA ;
--------------------------------------------------------
...
--  CREATE UNIQUE INDEX PK41 ON ACS_POS_TURNOVER (ENTITY_ID, POSITION_ID, EFFECTIVE_DATE, FREQUENCY) 
--  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
--  STORAGE(INITIAL 4300800 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
--  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
--  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
--  TABLESPACE TSDATA_EPAA ;
--------------------------------------------------------
--  Constraints for Table ACS_POS_TURNOVER
--------------------------------------------------------

--  ALTER TABLE ACS_POS_TURNOVER ADD CONSTRAINT PK41 PRIMARY KEY (ENTITY_ID, POSITION_ID, EFFECTIVE_DATE, FREQUENCY)
--  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
--  STORAGE(INITIAL 4300800 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
--  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
--  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
--  TABLESPACE TSDATA_EPAA  ENABLE;
--  ALTER TABLE ACS_POS_TURNOVER MODIFY (ENTITY_ID NOT NULL ENABLE);
--  ALTER TABLE ACS_POS_TURNOVER MODIFY (EFFECTIVE_DATE NOT NULL ENABLE);
--  ALTER TABLE ACS_POS_TURNOVER MODIFY (POSITION_ID NOT NULL ENABLE);
--  ALTER TABLE ACS_POS_TURNOVER MODIFY (FREQUENCY NOT NULL ENABLE);
--  ALTER TABLE ACS_POS_TURNOVER MODIFY (LAST_UPDATE_TS NOT NULL ENABLE);

  
--------------------------------------------------------
--  File created - Thursday-December-14-2017   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table BUSINESS_CALENDAR
--------------------------------------------------------
...
--  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
--  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
--  TABLESPACE PACE_MASTER ;
--------------------------------------------------------
--  DDL for Index PK_BUSINESS_CALENDAR
--------------------------------------------------------

--  CREATE UNIQUE INDEX PK_BUSINESS_CALENDAR ON BUSINESS_CALENDAR (SRC_INTFC_INST, BUSINESS_DATE) 
--  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
--  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
--  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
--  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
--  TABLESPACE PACE_MASTER ;
--------------------------------------------------------
--  DDL for Index ACS_BUSINESS_CALENDAR_INDX1
--------------------------------------------------------

--  CREATE INDEX ACS_BUSINESS_CALENDAR_INDX1 ON BUSINESS_CALENDAR (SRC_INTFC_INST, DAILY_FLAG, BUSINESS_DATE) 
--  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOLOGGING 
--  STORAGE(INITIAL 1433600 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
--  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
--  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
--  TABLESPACE TSINDX_EPA ;
--------------------------------------------------------
--  Constraints for Table BUSINESS_CALENDAR
--------------------------------------------------------

--  ALTER TABLE BUSINESS_CALENDAR MODIFY (SRC_INTFC_INST NOT NULL ENABLE);
--  ALTER TABLE BUSINESS_CALENDAR MODIFY (BUSINESS_DATE NOT NULL ENABLE);
--  ALTER TABLE BUSINESS_CALENDAR ADD CONSTRAINT PK_BUSINESS_CALENDAR PRIMARY KEY (SRC_INTFC_INST, BUSINESS_DATE)
--  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
--  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
--  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
--  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
--  TABLESPACE PACE_MASTER  ENABLE;
